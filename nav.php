    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="#">Gerador de Personas</a>
          <a class="dropdown-item" href="#">Gerador de Assuntos de Email</a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="http://rockcontent.com/ferramentas-de-marketing">Todas</a>
        </div>
      </li>
      <li class="nav-item">
